...
export class AssetassetmbrrecordtypeService {
    ...
    private resourceUrl = 'asset/api/assetassetmbrrecordtypes';
    private resourceSearchUrl = 'asset/api/_search/assetassetmbrrecordtypes';
    ...
    private convert(assetassetmbrrecordtype: Assetassetmbrrecordtype): Assetassetmbrrecordtype {
        const copy: Assetassetmbrrecordtype = Object.assign({}, assetassetmbrrecordtype);

        copy.lastmodifieddatetime = this.dateUtils.toDate(assetassetmbrrecordtype.lastmodifieddatetime);
        return copy;
    }
}
